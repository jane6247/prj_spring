...
<body>
  ...
  <main id="main" class="main">
	...
	<a href="codeGroupTableSearch"><button type="button" class="btn btn-primary" id="btn">Add</button></a>
</form>
	<c:choose>
	...
	<!-- $(list) 자바에서 넘겨준 객체 이름 --> <!-- var="list" jst1블럭에서 사용할 변수 이름 -->
		<c:forEach items="${list}" var="list" varStatus="status">
			<a href="/codeGroupTableSearch?seq=<c:out value="${list.seq}"/>"><c:out value="${list.name}"></c:out></a>
