	...
	<c:otherwise>
	           <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="name" id="name" value="<c:out value="${item.message }"/>">
                  </div>
                </div>
                
              <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Member_seq</label>
                  <div class="col-sm-10">
...
$("#btnUpdate").on("click", function(){
 	$("form[name=form]").attr("action", "/commUpdt").submit();
});


$("#btnDelete").on("click", function(){
 	$("form[name=form]").attr("action", "/commDele").submit();
});


$("#btnUelete").on("click", function(){
 	$("form[name=form]").attr("action", "/commUele").submit();
});


$("#btnSave").on("click", function(){
 	$("form[name=form]").attr("action", "/commInst").submit();
});
